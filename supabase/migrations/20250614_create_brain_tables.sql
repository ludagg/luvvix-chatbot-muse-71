...
-- Table pour stocker les connaissances centralisées de chaque utilisateur
...
CREATE TRIGGER set_user_brain_knowledge_updated_at
BEFORE UPDATE ON public.user_brain_knowledge
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

-- Commentaires
COMMENT ON TABLE public.user_brain_knowledge IS 'Stocke toutes les connaissances centralisées du cerveau IA pour chaque utilisateur';
COMMENT ON TABLE public.brain_interactions IS 'Interactions enrichies analysées par le cerveau central IA';
